...
let song=[
    ...
    {songName:"anbe anbe",filepath:"img/5.mp3 " ,coverpath:"img/nbe anbe.jpg"},
    {songName:"penne penne",filepath:"img/6.mp3" ,coverpath:"img/penne.jpg"},
    {songName:"aaga naga",filepath:"img/7.mp3 " ,coverpath:"img/Aga-Naga-song-out_-A-poster-of-Ponniyin-Selvan-2-1.jpg"},
    {songName:"ravadi",filepath:"img/8.mp3" ,coverpath:"img/sayyeshaa-289.jpg"},
    {songName:"uriye uriye",filepath:"img/9.mp3 " ,coverpath:"img/Thaandavam.jpg"},
]
// let part2="flase";
...
//     }
//     else{
//         element.getElementsByTagName('img')[0].src = song[8].coverpath;
//         element.getElementsByClassName('songName')[0].innerText = song[8].songName;
//     }
